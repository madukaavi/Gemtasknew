    ...
    <footer className="bg-white text-black py-6">
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap justify-between">
          ...
          <div className="w-full  h-auto flex mobile-320:items-center  mobile-320:justify-center items-start justify-start relative bottom-5 gap-2 mobile-320:top-12 ">
