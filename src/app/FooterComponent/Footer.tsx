      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap justify-between">
          <div className="w-full md:w-1/2 lg:w-1/6 mb-6 text-center md:text-left">
            ...
            <p className="text-base text-inter md:text-lg"><strong className="font-bold text-inter">Hours:</strong>  <span className="text-sm font-semibold"> 8:00 - 17:00, Mon - Sat</span></p>
          </div>
          <div className="w-full md:w-1/2 lg:w-1/6 mb-6 text-center md:text-left">
          ...
          <div className="w-full md:w-1/2 lg:w-1/6 mb-6 text-center md:text-left">
            ...
            <div className="flex justify-center md:justify-start space-x-4 text-base md:text-lg relative top-5">
              <a href="https://example.com/visa"><img className='h-[30px] w-[30px]' src="https://firebasestorage.googleapis.com/v0/b/gemgem-b7c15.appspot.com/o/logos_visaelectron.png?alt=media&token=579734ef-89ab-4df4-92ce-d41b873023d7" alt="Visa" /></a>
              <a href="https://example.com/mastercard"><img className='h-[30px] w-[30px]'  src="https://firebasestorage.googleapis.com/v0/b/gemgem-b7c15.appspot.com/o/logos_mastercard.png?alt=media&token=ef95d40a-7e80-4367-8d56-91ff91f7bd1e" alt="Mastercard" /></a>
              <a href="https://example.com/paypal"><img className='h-[30px] w-[30px]' src="https://firebasestorage.googleapis.com/v0/b/gemgem-b7c15.appspot.com/o/logos_amex.png?alt=media&token=248c7682-01bf-4179-b8ce-c80054823b44" alt="Paypal" /></a>
            </div>
          </div>
        </div>
      </div>
