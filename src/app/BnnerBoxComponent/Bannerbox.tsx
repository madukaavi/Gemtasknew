  ...
  return (
    <section className="relative w-full h-[300px] overflow-hidden">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white px-4 bg-black bg-opacity-50">
        ...
        <p className="text-4x1 mb-6 font-semibold font inter relative right-30">Get E-mail updates about our latest shop <br></br>and special offers.</p>
        <p className="text-4x1  font-semibold font inter relative right-30">and special offers.</p>
        <div className="flex flex-col items-center w-full max-w-md">
          <div className="flex w-full relative">
            <input
              type="text"
              placeholder="Search..."
              className=" w-[300px]  py-2 rounded-full border-none outline-none relative bottom-12 left-52"
            />
          </div>
        </div>
      </div>
