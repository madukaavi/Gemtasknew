  ...
  return (
    <section className="relative w-full h-[300px] overflow-hidden">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white px-4 bg-black bg-opacity-50">
        ...
        <p className="text-4x1  font-semibold font inter relative right-[50px]">Get E-mail updates about our latest shop</p>
        <p className="text-4x1  font-semibold font inter relative right-[50px]">and special offers.</p>
